#!/usr/bin/env python3
"""
🏛️ LINUS NanoGPT - Notre propre modèle GPT from scratch !
============================================================
...
class LinusCausalAttention(nn.Module):
    """
    ...
    def __init__(self, config: LinusGPTConfig):
        super().__init__()
        self.config = config
...
class LinusBlock(nn.Module):
    ...
    def __init__(self, config: LinusGPTConfig):
        super().__init__()
        self.attn = LinusCausalAttention(config)
        self.mlp = LinusMLP(config)
...
# ==============================================================================
# 🏛️ LINUS GPT - Le Modèle Complet
# ==============================================================================

class LinusGPT(nn.Module):
    """
    🏛️ LINUS GPT - Notre propre modèle de langage !
    ...
    def __init__(self, config: LinusGPTConfig):
        ...
        self.blocks = nn.ModuleList([
            LinusBlock(config) for _ in range(config.n_layer)
        ])
...
def test_linus_gpt():
    ...
    print("\n" + "=" * 60)
    print("🧪 TEST LINUS GPT")
    print("=" * 60)
    
    # Configuration mini pour test
    config = LinusGPTConfig(
        sequence_len=64,
