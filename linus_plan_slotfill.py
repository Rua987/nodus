...
# -*- coding: utf-8 -*-
"""
Slot-fill harnais — chainon entre plan LINUS (noms) et args executeur.

LINUS : ["grep", "read_file"]
...
from linus_verify import extract_expected_files  # noqa: E402  (pas de cycle)
...
def format_plan_with_targets(
    ...
    numbered = "\n".join(lines)
    return (
        "\n\n## SUGGESTED TOOL SEQUENCE (local LINUS + slot-fill)\n"
