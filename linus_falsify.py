...
# -*- coding: utf-8 -*-
"""
🏛️ TEMPLE IAM - LINUS FALSIFY
⚡ Reverse-LINUS : chercher un CONTRE-EXEMPLE exécuté, pas faire confiance à des cas fixes
...
def _build_falsify_runner(modname: str, moddir: str, falsify_dir: str,
    ...
    return "\n".join([
        ...
        "from linus_falsify import falsify",
...
def evaluate_falsify(props_file: str, cwd: Optional[str] = None,
    ...
    `linus_falsify` dans le sys.path pour qu'il soit importable.
    """
