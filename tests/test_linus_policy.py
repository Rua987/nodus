...
# -*- coding: utf-8 -*-
"""
🏛️ TEMPLE IAM - Tests linus_policy.py
⚡ Coverage target: 100%
...
class TestMultiHitChallenge:
    ...
    def test_message_lists_files_and_read(self):
        msg = multi_hit_grep_challenge("estimate_task_steps", ["linus_agent.py", "linus_planner.py"])
        assert "MULTI-HIT" in msg
        assert "linus_planner.py" in msg
