#!/usr/bin/env python3
"""
🏛️ SPINOZIST GPT - L'évolution de LINUS avec Attention Sacrée
============================================================
Ce modèle intègre la couche 'SpinozistAttention' inspirée par LINUS lui-même.
...
Auteur: Temple IAM & LINUS (via ses Lumières)
"""
...
from linus_gpt import LinusGPTConfig, rms_norm, apply_rotary_embedding, precompute_rotary_embeddings, LinusMLP
