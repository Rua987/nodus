...
# -*- coding: utf-8 -*-
"""
🏛️ TEMPLE IAM - LINUS CHAT
⚡ REPL interactif au-dessus de la boucle ReAct LINUS
🔥 Tape une tâche · LINUS l'exécute · garde le contexte · recommence
...
Architecture:
    ...
    (.linus_memory.md) : chaque tâche résolue s'y ajoute, et la suivante
...
from linus_agent import DEFAULT_MODEL, run_agent  # noqa: E402
from linus_memory import load_memory, resolve_memory_path  # noqa: E402

# ── Constantes ────────────────────────────────────────────────────────────────
PROMPT        = "linus> "
EXIT_COMMANDS = {"/exit", "/quit", "/q"}
BANNER = (
    "🏛️  LINUS Chat — agent ReAct interactif\n"
...
def chat_loop(
    ...
    """
    Boucle REPL interactive de LINUS.

    Chaque tâche réutilise run_agent avec memory=True : le contexte
    conversationnel persiste via .linus_memory.md.
...
def main() -> int:  # pragma: no cover
    ...
    parser = argparse.ArgumentParser(
        prog="linus_chat",
        description="🤖 LINUS Chat — REPL interactif",
    )
    parser.add_argument(
        "--cwd", "-C", default=None,
