...
Idée (vision "il apprend et devient plus efficace") :
    ...
    add_recipe / load / save        → persistance .linus_playbook.md
"""
...
# ── Constantes ────────────────────────────────────────────────────────────────
PLAYBOOK_FILE   = ".linus_playbook.md"
PLAYBOOK_HEADER = "# 🧭 LINUS Playbook (proven paths)"
MAX_RECIPES     = 20
...
def resolve_playbook_path(
    ...
    Priorité : playbook_path explicite > cwd/.linus_playbook.md > ./.linus_playbook.md.
    Fonction pure.
